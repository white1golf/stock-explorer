 ...
 * from "tiptap"
 *
 * https://github.com/ueberdosis/tiptap/blob/main/examples/helpers/svg-sprite-loader.js
 */
...
function svgSpriteInjector(source, opts) {
  ...
  if (source instanceof Node) {
    ...
    opts.revision =
      source.getAttribute('data-svg-sprite-revision') || opts.revision;
